...
WINDOWS_BINDINGS_FILE='
/* ~/Library/KeyBindings/DefaultKeyBinding.Dict
This file remaps the key bindings of a single user on Mac OS X 10.5 (or later) to more
closely match default behavior on Windows systems.  This particular mapping assumes
